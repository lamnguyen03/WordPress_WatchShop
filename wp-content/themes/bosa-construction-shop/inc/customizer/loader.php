...
function bosa_construction_shop_default_styles(){
	...
	$css .= '
		...
		.header-four .search-form button:hover,
		.header-four .search-form button:focus {
			background-color: '. esc_attr( $bottom_header_text_link_hover_color ) .';
		}
	';
...
add_action( 'wp_head', 'bosa_construction_shop_default_styles', 99 );