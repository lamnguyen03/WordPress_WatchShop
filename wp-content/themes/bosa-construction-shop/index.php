...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_construction_shop_blog_advertisement_banner(); ?>
			...
			<!-- Projects-->
			<?php get_template_part( 'template-parts/projects/projects' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-construction-shop' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-construction-shop' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-construction-shop' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-construction-shop' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-construction-shop' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
